    ...
    <div class="container h-100">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-6 bg-light border p-4 shadow-sm">
                ...
                @endif
                <form action="{{ route('documents.edu_sertificate.index_form_request') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12 mb-3">
                            ...
                            <input class="form-control" name='document_date' type="date" id="documetn_date" value="{{ $currentData }}">
                        </div>
                        <div class="col-md-12 col-lg-12 mb-3 d-md-flex">
                            ...
                            <a class="btn align-middle me-2" href="{{ route('documents.edu_sertificate.download_example')  }}"> <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down" viewBox="0 0 16 16">
